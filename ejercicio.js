...
let cumpleaños = 1996;
let cumpleañosFuturo = 2078;
let res = cumpleañosFuturo - cumpleaños;
...
let nombre = "Angel Cardozo";
let ubicacion = "Cuautitlan Izcalli";
let pasatiempo = "jugar Videojuegos";
console.log(`Hola, mi nombre es ${nombre}. Yo vivo en ${ubicacion} y me gusta mucho ${pasatiempo}.`)
